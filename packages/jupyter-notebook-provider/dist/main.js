...
function (_WebIONode) {
  ...
  function WebIOObservableNode(schema, context) {
    ...
    try {
      ...
      _this.observable.subscribe(_this.onObservableUpdate);
    } catch (e) {
      _this.node = null;
...
function (_WebIONode) {
  ...
  function WebIOScope(scopeData, options) {
    ...
    _this.element.setAttribute("data-webio-scope-id", scopeData.instanceArgs.id);
  ...
  _createClass(WebIOScope, [{
    ...
    value: function initialize(scopeData) {
      ...
      regeneratorRuntime.mark(function _callee() {
        ...
        var _scopeData$instanceAr4, _scopeData$instanceAr5, handlers, imports, _handlers$preDependen, preDependencies, _handlers$_promises, _promises, restHandlers, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, child, resources, importsLoadedHandler;
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                preDependencies.map(function (functionString) {
                  return Object(_events__WEBPACK_IMPORTED_MODULE_4__["createWebIOEventListener"])(_this2, functionString, _this2);
                ...
                Object.keys(restHandlers).forEach(function (observableName) {
                  _this2.handlers[observableName] = handlers[observableName].map(function (handlerString) {
                    return Object(_events__WEBPACK_IMPORTED_MODULE_4__["createWebIOEventListener"])(_this2, handlerString, _this2);
                  });
              ...
              case 31:
                ...
                if (resources && importsLoadedHandler) {
                  ...
                  Object(_events__WEBPACK_IMPORTED_MODULE_4__["createWebIOEventListener"])(this, importsLoadedHandler, this).apply(void 0, _toConsumableArray(resources));
...
var createNode = function createNode(nodeData, options) {
  var NodeClass = NODE_CLASSES[nodeData.nodeType];
  ...
  if (NodeClass) {
    ...
    return new NodeClass(nodeData, options);
  }

  throw new Error("Unknown WebIO node type: ".concat(nodeData.nodeType, "."));
};
...
var createWebIOEventListener = function createWebIOEventListener(_webIOThisContext, _webIOListenerSource, _webIOScope) {
  log("Creating event listener.", {
    context: _webIOThisContext,
    scope: _webIOScope,
  ...
  if (typeof _webIOListenerSource === "string") {
    ...
    // declaration).
    return eval("(".concat(_webIOListenerSource, ")")).bind(_webIOThisContext);
...
var _notebookReadyPromiseBody = function _notebookReadyPromiseBody() {
  if (base_js_namespace__WEBPACK_IMPORTED_MODULE_0__["notebook"] && base_js_namespace__WEBPACK_IMPORTED_MODULE_0__["notebook"].kernel && base_js_namespace__WEBPACK_IMPORTED_MODULE_0__["notebook"]._fully_loaded) {
    return Promise.resolve();
  }
...
var notebookReadyPromise = _notebookReadyPromiseBody();
/**

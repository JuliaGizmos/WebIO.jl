define(["base/js/namespace","notebook/js/outputarea","jquery"], function(__WEBPACK_EXTERNAL_MODULE_base_js_namespace__, __WEBPACK_EXTERNAL_MODULE_notebook_js_outputarea__, __WEBPACK_EXTERNAL_MODULE_jquery__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
!function () {
  ...
  function t(e, t) {
    nt || (t = t.replace(it ? /file:\/\/\//g : /file:\/\//g, ""));
    var r,
        n = (e.message || e) + "\n  " + t;
    r = lt && e.fileName ? new Error(n, e.fileName, e.lineNumber) : new Error(n);
  ...
  function n(e, t) {
    ...
    var d = e.indexOf(":");
    return -1 !== d ? ot && ":" === e[1] && "\\" === e[2] && e[0].match(/[a-z]/i) ? "file:///" + e.replace(/\\/g, "/") : e : void 0;
  }
  ...
  function S(e, r, n, o, i, a) {
    ...
    if (n.execute) if (n.setters) s = E(n.execute);else {
      ...
      var g = O(e, r.key, n.dependencies, n.dependencyInstantiations, o, i, a);
      if (!n.executingRequire) for (var f = 0; f < n.dependencies.length; f++) {
        g(n.dependencies[f]);
      }
  ...
  function C(e, t) {
    ...
    if (!wt) {
      ...
      wt = new r(n), wt.paths = r._nodeModulePaths(n);
    }
  ...
  function F(e) {
    ...
    jt ? (r.rel = "preload", r.as = "script") : r.rel = "prefetch", r.href = e, document.head.appendChild(r), document.head.removeChild(r);
  }
  ...
  function D(e, t, r, n, o) {
    ...
    if (e = e.replace(/#/g, "%23"), Et) return K(e, n, o);
  ...
  function $(e, t, r, n) {
    return "file:///" != e.substr(0, 8) ? Promise.reject(new Error('Unable to fetch "' + e + '". Only file URLs of the form file:/// supported running in Node.')) : (_t = _t || __webpack_require__(/*! fs */ "../../node_modules/node-libs-browser/mock/empty.js"), e = it ? e.replace(/\//g, "\\").substr(8) : e.substr(7), new Promise(function (t, r) {
      _t.readFile(e, function (e, o) {
        if (e) return r(e);
        if (n) t(o);else {
          var i = o + "";
  ...
  function H(e, t) {
    ...
    return Promise.resolve().then(function () {
      ...
      var n = ge.call(i, e.substr(r + 2));
      return he.call(i, n, t, !0).then(function (t) {
        return t ? e.substr(0, r) : "@empty";
      });
    }).then(function (e) {
      var a = re(r.pluginFirst, e);
      return a ? (n.pluginKey = a.plugin, Promise.all([V.call(i, r, a.argument, o && o.pluginArgument || t, n, o, !0), i.resolve(a.plugin, t)]).then(function (e) {
        ...
        return ne(r.pluginFirst, e[0], e[1]);
  ...
  function Z(e, t) {
    var r = re(e.pluginFirst, t);

    if (r) {
      var n = Z.call(this, e, r.plugin);
      return ne(e.pluginFirst, Y.call(this, e, r.argument, void 0, !1, !1), n);
    }
  ...
  function X(e, t) {
    var r = this[Ot],
        n = W(),
        o = o || G(this, r, t),
        i = re(r.pluginFirst, e);
    return i ? (n.pluginKey = X.call(this, i.plugin, t), ne(r.pluginFirst, Q.call(this, r, i.argument, o.pluginArgument || t, n, o, !!n.pluginKey), n.pluginKey)) : Q.call(this, r, e, o.pluginArgument || t, n, o, !!n.pluginKey);
  }

  function Y(e, t, r, o, i) {
    var a = n(t, r || rt);
    if (a) return U(e.baseURL, e.paths, a);

    if (o) {
      var s = z(e.map, t);
      if (s && (t = e.map[s] + t.substr(s.length), a = n(t, rt))) return U(e.baseURL, e.paths, a);
    }

    if (this.registry.has(t)) return t;
    if ("@node/" === t.substr(0, 6)) return t;
    var u = i && "/" !== t[t.length - 1],
        l = U(e.baseURL, e.paths, u ? t + "/" : t);
  ...
  function Q(e, t, r, n, o, i) {
    ...
    n.packageConfig = e.packages[n.packageKey] || (e.packages[n.packageKey] = xe());
    var f = l.substr(n.packageKey.length + 1);
    return ie(this, e, n.packageConfig, n.packageKey, f, n, i);
  }
    ...
    return kt.then(function () {
      if (o && o.packageConfig && "./" !== t.substr(0, 2)) {
        var r = o.packageConfig.map,
            s = r && z(r, t);
        if (s) return le(a, e, o.packageConfig, o.packageKey, s, t, n, i);
      }

      return kt;
    }).then(function (o) {
      if (o) return o;
      var s = Y.call(a, e, t, r, !0, !0),
          u = fe(e, s);
      if (n.packageKey = u && u.packageKey || z(e.packages, s), !n.packageKey) return Promise.resolve(s);
      if (-1 !== e.packageConfigKeys.indexOf(s)) return n.packageKey = void 0, n.load = ee(), n.load.format = "json", Promise.resolve(s);
      n.packageConfig = e.packages[n.packageKey] || (e.packages[n.packageKey] = xe());
      var l = u && !n.packageConfig.configured;
      return (l ? de(a, e, u.configPath, n) : kt).then(function () {
        var t = s.substr(n.packageKey.length + 1);
        return ue(a, e, n.packageConfig, n.packageKey, t, n, i);
      });
    });
  }
  ...
  function te(e, t, r) {
    ...
    if (e.meta[t] && I(r.load, e.meta[t], !1), r.packageKey) {
      ...
      if (r.packageConfig.meta) {
        var o = 0;
        pe(r.packageConfig.meta, s, function (e, t, r) {
          r > o && (o = r), I(u, t, r && o > r);
        }), I(r.load, u, !1);
      }
  ...
  function oe(e, t, r, n, o) {
    ...
    var i = !1;
    if (t.meta && pe(t.meta, n, function (e, t, r) {
  ...
  function ie(e, t, r, n, o, i, a) {
    ...
    if (r.map) {
      ...
      if (u || (s = "./" + oe(e, r, n, o, a), s !== "./" + o && (u = z(r.map, s))), u) {
  ...
  function se(e, t, r, n, o, i, a, s) {
    ...
    if (ae(o, u, i) && "string" == typeof u) return Q.call(this, t, u + i.substr(o.length), n + "/", a, a, s);
  }
  ...
  function ue(e, t, r, n, o, i, a) {
    ...
    var s, u;
    return r.map && (s = "./" + o, u = z(r.map, s), u || (s = "./" + oe(e, r, n, o, a), s !== "./" + o && (u = z(r.map, s)))), (u ? le(e, t, r, n, u, s, i, a) : kt).then(function (t) {
  ...
  function le(e, t, r, n, o, i, a, s) {
    "/" === i[i.length - 1] && (i = i.substr(0, i.length - 1));
    var u = r.map[o];
    if ("string" == typeof u) return ae(o, u, i) ? V.call(e, t, u + i.substr(o.length), n + "/", a, a, s).then(function (t) {
    ...
    return Promise.all(l).then(function (e) {
      for (var t = 0; t < c.length; t++) {
        var r = c[t].condition,
            n = T(r.prop, e[t].__useDefault ? e[t].default : e[t]);
  ...
  function ge(e) {
    var t,
        ...
        n,
        o = e.lastIndexOf("|");
    return -1 !== o ? (t = e.substr(o + 1), r = e.substr(0, o), "~" === t[0] && (n = !0, t = t.substr(1))) : (n = "~" === e[0], t = "default", r = e.substr(n), -1 !== Kt.indexOf(r) && (t = r, r = null)), {
      module: r || "@system-env",
      prop: t,
      negate: n
    };
  ...
  function me(e, t, r) {
    ...
    var o = ge.call(this, n[0].substr(2, n[0].length - 3));
    return he.call(this, o, t, !1).then(function (r) {
  ...
  function ve(e, t, r) {
    for (var n = 0; n < Tt.length; n++) {
      var o = Tt[n];
      t[o] && kr[o.substr(0, o.length - 6)] && r(t[o]);
    }
  }
  ...
  function ye(e, t) {
    ...
    for (var n in e) {
      var o = e[n];
      t > 1 ? "object" == _typeof(o) ? r[n] = ye(o, t - 1) : "packageConfig" !== n && (r[n] = o) : r[n] = o;
    }
  ...
  function be(e, t) {
    var r = e[t];
    return r instanceof Array ? e[t].concat([]) : "object" == _typeof(r) ? ye(r, 3) : e[t];
  }

  function we(e) {
    if (e) {
      if (-1 !== xr.indexOf(e)) return be(this[Ot], e);
      throw new Error('"' + e + '" is not a valid configuration name. Must be one of ' + xr.join(", ") + ".");
    }
  ...
  function ke(e, t) {
    ...
    if ("warnings" in e && (o.warnings = e.warnings), "wasm" in e && (o.wasm = "undefined" != typeof WebAssembly && e.wasm), ("production" in e || "build" in e) && et.call(r, !!e.production, !!(e.build || kr && kr.build)), !t) {
      var i;
      ve(r, e, function (e) {
        i = i || e.baseURL;
      ...
      for (var a in o.paths) {
        -1 !== o.paths[a].indexOf("*") && (_.call(o, "Path config " + a + " -> " + o.paths[a] + " is no longer supported as wildcards are deprecated."), delete o.paths[a]);
      }
    }

    if (e.defaultJSExtensions && _.call(o, "The defaultJSExtensions configuration option is deprecated.\n  Use packages defaultExtension instead.", !0), "boolean" == typeof e.pluginFirst && (o.pluginFirst = e.pluginFirst), e.map) for (var a in e.map) {
      var s = e.map[a];
      if ("string" == typeof s) o.map[a] = Y.call(r, o, s, void 0, !1, !1);else {
        var u = Y.call(r, o, a, void 0, !0, !0),
            l = o.packages[u];
        l || (l = o.packages[u] = xe(), l.defaultExtension = ""), Oe(l, {
          map: s
        }, u, !1, o);
      }
    }
    ...
    if (e.packageConfigPaths) {
      for (var c = [], f = 0; f < e.packageConfigPaths.length; f++) {
        var d = e.packageConfigPaths[f],
            ...
            g = Y.call(r, o, d.substr(0, p), void 0, !1, !1);
        c[f] = g + d.substr(p);
      }
    ...
    if (e.packages) for (var a in e.packages) {
      ...
      var u = Y.call(r, o, "/" !== a[a.length - 1] ? a + "/" : a, void 0, !0, !0);
      u = u.substr(0, u.length - 1), Oe(o.packages[u] = o.packages[u] || xe(), e.packages[a], u, !1, o);
    }
    ...
    if (e.meta) for (var a in e.meta) {
      if ("*" === a[0]) L(o.meta[a] = o.meta[a] || {}, e.meta[a]);else {
        var m = Y.call(r, o, a, void 0, !0, !0);
        L(o.meta[m] = o.meta[m] || {}, e.meta[a]);
      }
    }
  ...
  function Oe(e, t, r, n, o) {
    for (var i in t) {
      "main" === i || "format" === i || "defaultExtension" === i || "configured" === i ? n && void 0 !== e[i] || (e[i] = t[i]) : "map" === i ? (n ? A : L)(e.map = e.map || {}, t.map) : "meta" === i ? (n ? A : L)(e.meta = e.meta || {}, t.meta) : Object.hasOwnProperty.call(t, i) && _.call(o, '"' + i + '" is not a valid package configuration option in package ' + r);
    }
  ...
  function je(e, t, r, n, o) {
    qt || (qt = document.head || document.body || document.documentElement);
  ...
  function Me(e, t, r, n, o, i, a) {
    if (t) {
      if (i && Wt) return je(e, t, r, n, i);

      try {
        Re(e), !zt && e._nodeRequire && (zt = e._nodeRequire("vm"), Nt = zt.runInThisContext("typeof System !== 'undefined' && System") === e), Nt ? zt.runInThisContext(Ee(t, r, n, !a), {
          filename: n + (r ? "!transpiled" : "")
        }) : (0, eval)(Ee(t, r, n, !a)), Pe();
      } catch (e) {
        return Pe(), e;
      }
    }
  ...
  function Ce(e, t) {
    return _e(this.normalizeSync(e, t));
  }
  ...
  function Ae(e) {
    ...
    Lt.lastIndex = Vt.lastIndex = er.lastIndex = 0;
    var r,
        n = [],
        o = [],
        i = [];
  ...
  function Fe(e) {
    if ("string" == typeof e) return T(e, at);
  ...
  function Ke(e, t, r, n) {
    ...
    return t || (Zt = {}, Object.keys(at).forEach(Ie, function (e, t) {
      ...
      var e,
          r = t ? Fe(t) : {},
          a = !!t;
      if ((!t || n) && Object.keys(at).forEach(Ie, function (o, i) {
  ...
  function De(e, t) {
    ...
    var r = e.match(or),
        ...
        o = ar[n] || (ar[n] = new RegExp(rr + n + nr, "g"));
    o.lastIndex = 0;
  ...
  function Te(e) {
    return function (t, r, n) {
      e(t, r, n), Object.defineProperty(n.exports, "__esModule", {
        value: !0
      });
    };
  }
  ...
  function ze(e, t) {
    !e.load.esModule || "__esModule" in t || Object.defineProperty(t, "__esModule", {
      value: !0
    });
  }
  ...
  function Ne(e, t) {
    var r = this,
        n = this[Ot],
        o = this[St][e];
    return ($e(n, this, e) || kt).then(function () {
      if (!t()) {
        ...
        return o.load.scriptLoad ? (o.load.pluginKey || !lr) && (o.load.scriptLoad = !1, _.call(n, 'scriptLoad not supported for "' + e + '"')) : o.load.scriptLoad !== !1 && !o.load.pluginKey && lr && (o.load.deps || o.load.globals || !("system" === o.load.format || "register" === o.load.format || "global" === o.load.format && o.load.exports) || (o.load.scriptLoad = !0)), o.load.scriptLoad ? new Promise(function (n, i) {
          if ("amd" === o.load.format && at.define !== r.amdDefine) throw new Error("Loading AMD with scriptLoad requires setting the global `" + fr + ".define = SystemJS.amdDefine`");
          D(e, o.load.crossOrigin, o.load.integrity, function () {
            if (!t()) {
              o.load.format = "global";
              var e = o.load.exports && Fe(o.load.exports);
  ...
  function Be(e, t, r, n, o) {
    return r.load.exports && !r.load.format && (r.load.format = "global"), kt.then(function () {
      return r.pluginModule && r.pluginModule.locate ? Promise.resolve(r.pluginModule.locate.call(e, r.pluginLoad)).then(function (e) {
      ...
      }) : It(r.pluginLoad.address, r.load.authorization, r.load.integrity, !1)) : It(t, r.load.authorization, r.load.integrity, o);
    }).then(function (i) {
      if (!o || "string" == typeof i) return We(e, t, i, r, n);
    ...
    return Promise.resolve(r).then(function (t) {
      return "detect" === n.load.format && (n.load.format = void 0), Qe(t, n), n.pluginModule && n.pluginModule.translate ? (n.pluginLoad.source = t, Promise.resolve(n.pluginModule.translate.call(e, n.pluginLoad, n.traceOpts)).then(function (e) {
        if (n.load.sourceMap) {
          ...
          Ze(n.pluginLoad.address, n.load.sourceMap);
        }
      ...
      n.load.format || (n.load.format = He(r));
      var i = !1;
      ...
      switch (n.load.format) {
        ...
        case "register":
        case "system":
          var a = Me(e, r, n.load.sourceMap, t, n.load.integrity, n.load.nonce, !1);
          if (a) throw a;
          if (!o()) return xt;
          return;
        ...
        case "amd":
          var s = at.define;
          at.define = e.amdDefine, Ue(n.load.deps, n.load.esModule);
          var a = Me(e, r, n.load.sourceMap, t, n.load.integrity, n.load.nonce, !1);
          if (i = o(), i || (qe(e), i = o()), at.define = s, a) throw a;
          break;

        case "cjs":
          var u = n.load.deps,
              l = (n.load.deps || []).concat(n.load.cjsRequireDetection ? Ae(r) : []);
          ...
          e.registerDynamic(l, !0, function (o, i, a) {
            ...
            var l = Le(a.id),
                c = {
              exports: i,
              args: [o, i, a, l.filename, l.dirname, at, at]
            },
            ...
            var p = at.define;
            at.define = void 0, at.__cjsWrapper = c, r = f + ") {" + r.replace(mr, "") + "\n}).apply(__cjsWrapper.exports, __cjsWrapper.args);";
            var g = Me(e, r, n.load.sourceMap, t, n.load.integrity, n.load.nonce, !1);
            if (g) throw g;
            ze(n, i), at.__cjsWrapper = void 0, at.define = p;
          }), i = o();
          break;
        ...
        case "global":
          ...
          e.registerDynamic(l, !1, function (o, i, a) {
            ...
            l && (r += "\n" + fr + '["' + l + '"] = ' + l + ";");
            var c = Ke(a.id, l, s, n.load.encapsulateGlobal),
                f = Me(e, r, n.load.sourceMap, t, n.load.integrity, n.load.nonce, !0);
            if (f) throw f;
            var d = c();
            return ze(n, d), d;
          }), i = o();
  ...
  function Xe(e, r, n, o, i) {
    ...
    return e.import.call(e, e.transpiler).then(function (t) {
      if (t.__useDefault && (t = t.default), !t.translate) throw new Error(e.transpiler + " is not a valid transpiler plugin.");
      return t === o.pluginModule ? r : ("string" == typeof o.load.sourceMap && (o.load.sourceMap = JSON.parse(o.load.sourceMap)), o.pluginLoad = o.pluginLoad || {
        ...
        return t && "object" == _typeof(t) && Ze(n, t), "esm" === o.load.format && Ge(e) && (o.load.format = "register"), e;
      }));
    }, function (e) {
  ...
  function Qe(e, t) {
    var r = e.match(vr);
    if (r) for (var n = r[0].match(yr), o = 0; o < n.length; o++) {
      var i = n[o],
          a = i.length,
          s = i.substr(0, 1);
      ...
      if (";" == i.substr(a - 1, 1) && a--, '"' == s || "'" == s) {
        ...
        if (l) {
          ...
          "deps" === l && (l = "deps[]"), "[]" === l.substr(l.length - 2, 2) ? (l = l.substr(0, l.length - 2), t.load[l] = t.load[l] || [], t.load[l].push(c)) : "use" !== l && Ye(t.load, l, c);
        } else t.load[u] = !0;
      }
    }
  }
  ...
  function Ve() {
    f.call(this), this._loader = {}, this[St] = {}, this[Ot] = {
      baseURL: rt,
      paths: {},
      packageConfigPaths: [],
      packageConfigKeys: [],
      ...
      pluginFirst: !1,
      wasm: !1
    }, this.scriptSrc = cr, this._nodeRequire = Qt, this.registry.set("@empty", xt), et.call(this, !1, !1), Ht(this);
  }

  function et(e, t) {
    this[Ot].production = e, this.registry.set("@system-env", kr = this.newModule({
      browser: nt,
  ...
  function tt(e, t) {
    _.call(e[Ot], "SystemJS." + t + " is deprecated for SystemJS.registry." + t);
  }
  ...
  var rt,
      ...
      st = "undefined" != typeof Symbol;

  if ("undefined" != typeof document && document.getElementsByTagName) {
    if (rt = document.baseURI, !rt) {
      var ut = document.getElementsByTagName("base");
      rt = ut[0] && ut[0].href || window.location.href;
    }
  } else "undefined" != typeof location && (rt = location.href);

  if (rt) rt = rt.split("#")[0].split("?")[0], rt = rt.substr(0, rt.lastIndexOf("/") + 1);else {
    if ("undefined" == typeof process || !process.cwd) throw new TypeError("No environment baseURI");
    rt = "file://" + (it ? "/" : "") + process.cwd(), it && (rt = rt.replace(/\\/g, "/"));
  }
  "/" !== rt[rt.length - 1] && (rt += "/");
  var lt = "_" == new Error(0, "_").fileName,
      ct = Promise.resolve();
  ...
  var ft = i.resolve = e("resolve"),
      dt = i.resolveInstantiate = e("resolveInstantiate");
  i.prototype[dt] = function (e, t) {
    var r = this;
  ...
  var pt = "undefined" != typeof Symbol && Symbol.iterator,
      gt = e("registry");
  pt && (u.prototype[Symbol.iterator] = function () {
  ...
  var _t,
      ...
      At = "undefined" != typeof XMLHttpRequest;

  Ct = "undefined" != typeof self && "undefined" != typeof self.fetch ? N : At ? J : "undefined" != "function" && "undefined" != typeof process ? $ : B;
  var It = Ct,
      Ft = {},
      Kt = ["browser", "node", "dev", "build", "production", "default"],
      Dt = /#\{[^\}]+\}/,
      Tt = ["browserConfig", "nodeConfig", "devConfig", "buildConfig", "productionConfig"],
      Ut = "undefined" != typeof Buffer;
  ...
  var qt,
      ...
      Bt = 0,
      Wt = !1;
  nt && "undefined" != typeof document && document.getElementsByTagName && (window.chrome && window.chrome.extension || navigator.userAgent.match(/^Node\.js/) || (Wt = !0));
  ...
  var Gt,
    ...
    function r(r, n, o) {
      function i(r, i, l) {
        ...
        var p = at.require;
        at.require = t;
        var g = o.apply(-1 === s ? at : i, c);
        at.require = p, "undefined" != typeof g && (l.exports = g);
      }
      ...
      }(o)), r || Yt && (n = n.concat(Yt), Yt = void 0);
      var a, s, u;
      -1 !== (a = n.indexOf("require")) && (n.splice(a, 1), r || (n = n.concat(De(o.toString(), a)))), -1 !== (s = n.indexOf("exports")) && n.splice(s, 1), -1 !== (u = n.indexOf("module")) && n.splice(u, 1), r ? (e.registerDynamic(r, n, !1, i), Xt ? (Xt = void 0, sr = !0) : sr || (Xt = [n, i])) : e.registerDynamic(n, !1, ur ? Te(i) : i);
    }

    e.set("@@cjs-helpers", e.newModule({
      requireResolve: Ce.bind(e),
      getPathVars: Le
  ...
  "undefined" != typeof window && "undefined" != typeof document && window.location && (Gt = location.protocol + "//" + location.hostname + (location.port ? ":" + location.port : ""));
  var Zt,
      Xt,
      Yt,
      Qt,
      ...
      sr = !1,
      ur = !1,
      lr = (nt || Et) && "undefined" != typeof navigator && navigator.userAgent && !navigator.userAgent.match(/MSIE (9|10).0/);
  "undefined" == "function" || "undefined" == typeof process || process.browser || (Qt = require);
  var cr,
  ...
  if ("undefined" != typeof document) {
    var br = document.getElementsByTagName("script"),
        wr = br[br.length - 1];
    document.currentScript && (wr.defer || wr.async) && (wr = document.currentScript), cr = wr && wr.src;
  ...
  } else "undefined" != typeof __filename && (cr = __filename);

  var kr;
  Ve.prototype = Object.create(f.prototype), Ve.prototype.constructor = Ve, Ve.prototype[Ve.resolve = f.resolve] = Ve.prototype.normalize = H, Ve.prototype.load = function (e, t) {
    return _.call(this[Ot], "System.load is deprecated."), this.import(e, t);
  ...
  for (var xr = ["baseURL", "map", "paths", "packages", "packageConfigPaths", "depCache", "meta", "bundles", "transpiler", "warnings", "pluginFirst", "production", "wasm"], Or = "undefined" != typeof Proxy, Sr = 0; Sr < xr.length; Sr++) {
    (function (e) {
      Object.defineProperty(Ve.prototype, e, {
        get: function get() {
          var t = be(this[Ot], e);
          return Or && "object" == _typeof(t) && (t = new Proxy(t, {
  ...
  Ve.prototype.delete = function (e) {
    ...
    return new l(e);
  }, Ve.prototype.isModule = M, Ve.prototype.register = function (e, t, r) {
  ...
  }, Ve.prototype.version = "0.20.6 Dev";
  var Er = new Ve();
  (nt || Et) && (at.SystemJS = at.System = Er), "undefined" != typeof module && module.exports && (module.exports = Er);
}();
...
function (_super) {
  ...
  function WebIOScope(schema, context) {
    ...
    Object.keys(observables).forEach(function (name) {
      _this.observables[name] = new Observable_1.default(name, observables[name], _this);
    });
  ...
  WebIOScope.prototype.evokeListeners = function (name) {
    var _this = this;
    ...
    listeners.forEach(function (listener) {
      listener.call(_this.element, _this.getObservableValue(name), _this);
    });
  }; // /**
...
var debug = debug__WEBPACK_IMPORTED_MODULE_4___default()("WebIO:jupyter-notebook");
...
var getWebIOMetadata = function getWebIOMetadata() {
  var _ref = base_js_namespace__WEBPACK_IMPORTED_MODULE_0__["notebook"].metadata[WEBIO_METADATA_KEY] || {},
      _ref$lastKernelId = _ref.lastKernelId,
      lastKernelId = _ref$lastKernelId === void 0 ? null : _ref$lastKernelId,
      _ref$lastCommId = _ref.lastCommId,
      lastCommId = _ref$lastCommId === void 0 ? null : _ref$lastCommId;

  return {
    lastKernelId: lastKernelId,
...
var setWebIOMetadata = function setWebIOMetadata() {
  var data = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {
    lastKernelId: null,
    lastCommId: null
  };
  debug("Setting WebIO notebook metadata.", data);
  base_js_namespace__WEBPACK_IMPORTED_MODULE_0__["notebook"].metadata[WEBIO_METADATA_KEY] = data;

  if (data.lastKernelId === null) {
    debug("Clearing all WebIO cell/output metadata.");
    base_js_namespace__WEBPACK_IMPORTED_MODULE_0__["notebook"].get_cells().forEach(clearWebIOCellMetadata);
  }

  base_js_namespace__WEBPACK_IMPORTED_MODULE_0__["notebook"].set_dirty(true);
};
/**
...
var initializeWebIO = function initializeWebIO() {
  ...
  var _getWebIOMetadata = getWebIOMetadata(),
      lastKernelId = _getWebIOMetadata.lastKernelId,
      lastCommId = _getWebIOMetadata.lastCommId;

  if (!force && webIO && base_js_namespace__WEBPACK_IMPORTED_MODULE_0__["notebook"].kernel.id === lastKernelId) {
  ...
  debug("The last kernel id was ".concat(lastKernelId, " and the last comm id was ").concat(lastCommId, ". The current kernel id is ").concat(base_js_namespace__WEBPACK_IMPORTED_MODULE_0__["notebook"].kernel.id, "."));
  var shouldReuseCommId = // To re-use the comm id, we need to be using the same kernel.
  lastKernelId === base_js_namespace__WEBPACK_IMPORTED_MODULE_0__["notebook"].kernel.id // We need to know what the last comm id *was*
  && !!lastCommId // There can't already be a comm of that id
  && !(lastCommId in base_js_namespace__WEBPACK_IMPORTED_MODULE_0__["notebook"].kernel.comm_manager.comms);
  debug("We decided that we ".concat(shouldReuseCommId ? "should" : "shouldn't", " re-use the comm id."));
  var newCommId = shouldReuseCommId ? lastCommId : undefined;
  debug("newCommId is:", newCommId);
  debug("Creating new WebIO instance (kernel id: ".concat(base_js_namespace__WEBPACK_IMPORTED_MODULE_0__["notebook"].kernel.id, ")."));
  webIO = new _webio_webio__WEBPACK_IMPORTED_MODULE_3___default.a();
  ...
  var comm = commManager.new_comm("webio_comm", // target_name
  {}, // data
  undefined, // callbacks
  undefined, // metadata
  newCommId, // comm_id
  ...
  debug("comm's actual id is ".concat(comm.comm_id, ", we told it ").concat(newCommId, "."));
  ...
  setWebIOMetadata({
    ...
    lastKernelId: base_js_namespace__WEBPACK_IMPORTED_MODULE_0__["notebook"].kernel.id
  });
  rerenderWebIOCells();
};
/**
...
var appendWebIONode = function appendWebIONode(data, metadata, element) {
  debug("Rendering WebIO MIME type (called by Jupyter).", data); // Set metadata attributes if not already set.

  metadata[WEBIO_NODE_MIME] = metadata[WEBIO_NODE_MIME] || {};
  metadata[WEBIO_NODE_MIME].kernelId = metadata[WEBIO_NODE_MIME].kernelId !== undefined ? metadata[WEBIO_NODE_MIME].kernelId : base_js_namespace__WEBPACK_IMPORTED_MODULE_0__["notebook"].kernel.id; // Check if the widget was rendered against a different kernel.
  ...
  if (metadata[WEBIO_NODE_MIME].kernelId !== base_js_namespace__WEBPACK_IMPORTED_MODULE_0__["notebook"].kernel.id) {
    var _toInsert = this.create_output_subarea(metadata, "", WEBIO_NODE_MIME);

    _toInsert.append(jquery__WEBPACK_IMPORTED_MODULE_2___default()("<div><p><strong>" + "This WebIO widget was rendered for a Jupyter kernel that is no longer running. " + "Re-run this cell to regenerate this widget." + "</strong></p></div>"));

    element.append(_toInsert);
    return;
...
var initializeJupyterOutputType = function initializeJupyterOutputType() {
  if (!notebook_js_outputarea__WEBPACK_IMPORTED_MODULE_1__["OutputArea"].output_types.includes(WEBIO_NODE_MIME)) {
    debug("Registering WebIO node MIME type (".concat(WEBIO_NODE_MIME, ")."));
  ...
  debug("OutputArea display order:", notebook_js_outputarea__WEBPACK_IMPORTED_MODULE_1__["OutputArea"].display_order);
};

var load_ipython_extension = function load_ipython_extension() {
  if (!base_js_namespace__WEBPACK_IMPORTED_MODULE_0__ || !base_js_namespace__WEBPACK_IMPORTED_MODULE_0__["notebook"] || !base_js_namespace__WEBPACK_IMPORTED_MODULE_0__["notebook"].kernel) {
    return setTimeout(load_ipython_extension, INITIALIZATION_DEBOUNCE);
  }

  initializeJupyterOutputType(); // Initialize WebIO and re-initialize every time the kernel is restarted/ready.
  ...
  base_js_namespace__WEBPACK_IMPORTED_MODULE_0__["notebook"].kernel.send_shell_message("kernel_info_request", {}, {
    shell: {
  ...
  base_js_namespace__WEBPACK_IMPORTED_MODULE_0__["notebook"].events.on("kernel_ready.Kernel", function () {
  ...
  base_js_namespace__WEBPACK_IMPORTED_MODULE_0__["notebook"].events.on("kernel_killed.Session kernel_restarting.Kernel", function () {
    setWebIOMetadata();
  });
};
setTimeout(function () {
...
/***/ 0:
/*!*************************************************!*\
  !*** multi @babel/polyfill jupyter-notebook.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! @babel/polyfill */"../../node_modules/@babel/polyfill/lib/index.js");
module.exports = __webpack_require__(/*! jupyter-notebook.js */"./jupyter-notebook.js");

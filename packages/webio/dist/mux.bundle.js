...
/* harmony import */ var _createNode__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./createNode */ "./createNode.ts");
...
/* harmony import */ var debug__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(debug__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _Node__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Node */ "./Node.ts");
/* harmony import */ var _Observable__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Observable */ "./Observable.ts");
...
/* harmony import */ var _createNode__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./createNode */ "./createNode.ts");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
  ...
  function WebIOScope(scopeData, options) {
    ...
    Object.keys(handlers).forEach(function (observableName) {
      _this.handlers[observableName] = handlers[observableName].map(function (handlerString) {
        return Object(_events__WEBPACK_IMPORTED_MODULE_4__["createWebIOEventListener"])(_this.element, handlerString, _assertThisInitialized(_assertThisInitialized(_this)));
      });
    }); // TODO

    _this.promises = null;

    _this.webIO.registerScope(_assertThisInitialized(_assertThisInitialized(_this))); // this.node = node;
  ...
  _createClass(WebIOScope, [{
    ...
    value: function evokeListeners(name) {
      ...
      listeners.forEach(function (listener) {
        listener.call(_this2.element, _this2.getObservableValue(name), _this2);
      });
    }
    /**
     * @deprecated
...
/* harmony import */ var debug__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! debug */ "../node_modules/debug/src/browser.js");
/* harmony import */ var debug__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(debug__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _createNode__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./createNode */ "./createNode.ts");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
/***/ 0:
/*!*********************************************************!*\
  !*** multi @babel/polyfill providers/mux-entrypoint.ts ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! @babel/polyfill */"../node_modules/@babel/polyfill/lib/index.js");
module.exports = __webpack_require__(/*! providers/mux-entrypoint.ts */"./providers/mux-entrypoint.ts");

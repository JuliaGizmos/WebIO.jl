...
var WebIOScope = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        ...
                        preDependencies
                            .map(function (functionString) { return events_1.evalWithWebIOContext(_this, functionString, { scope: _this, webIO: _this.webIO }); })
                        ...
                        Object.keys(restHandlers).forEach(function (observableName) {
                            _this.handlers[observableName] = handlers[observableName].map(function (handlerString) {
                                return events_1.evalWithWebIOContext(_this, handlerString, { scope: _this, webIO: _this.webIO });
                            });
                        });
                    ...
                    case 3:
                        ...
                        if (resources && importsLoadedHandlers) {
                            ...
                            handlers_1 = importsLoadedHandlers.map(function (handler) {
                                return events_1.evalWithWebIOContext(_this, handler, { scope: _this, webIO: _this.webIO });
                            });
    ...
    WebIOScope.prototype.send = function (_a) {
        var _b = _a.scope, scope = _b === void 0 ? this.id : _b, rest = __rest(_a, ["scope"]);
        return this.webIO.send(__assign({ scope: scope }, rest));
    };
    /**
    ...
    WebIOScope.prototype.setupScope = function () {
        return this.send({
            command: "_setup_scope" /* SETUP_SCOPE */,
            data: {},
        });
    };
    return WebIOScope;

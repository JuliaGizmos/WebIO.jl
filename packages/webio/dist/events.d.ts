 ...
 */
export declare const evalWithWebIOContext: (_webIOThis: HTMLElement | SVGElement | HTMLInputElement | WebIOScope, _webIOListenerSource: string | EventListener, _webIOContext: WebIONodeContext) => EventListener;
